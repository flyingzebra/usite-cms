		...
		<table cellspacing=0 cellpadding=0>
			...
			for (var objEnum=new Enumerator(FileCollection); !objEnum.atEnd() ; objEnum.moveNext())
			{
					...
					&& strFileName.substring(3,13)==zerofill(dt,10) )
			  {
				...
				Response.Write("<tr><td valign=top style=font-size:15px;font-family:Georgia;font-weight:bold><img src=../"+idir+"/images/"+escape(strFileName)+"> "+photoname+"<br><br></td></tr>\r\n");
			  }
			}
			%>
		</table>
