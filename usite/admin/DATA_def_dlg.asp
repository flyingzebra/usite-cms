<%
	...
	var tablefld = new Array("rev_id","rev_title","rev_desc","rev_header","rev_rev","rev_ref","rev_rt_cat","rev_address","rev_phone","rev_fax","rev_mod_acc_id","rev_mod_date","rev_publisher","rev_email","rev_url","rev_date_published","rev_pub" ) 
	var formfld  = new Array("id"    ,"title"    ,"desc"    ,"header"    ,"rev"    ,"refcat" ,"category"  ,"address"    ,"phone"    ,"fax"    ,"mod_acc"	     ,"mod_date"    ,"publisher"    ,"email"   ,"url"    ,"pub_date"          ,"pub"     ,"act", "source")
...
<tr>
	<td align="right" style="background-color:white"><%=_T["admin_title"]%> »</td><td align="right" style="background-color:#e0e0e0" width=100><input name="title" type="text" value="<%=formarr[enumfld["title"]]%>" style="width:100px"></td>
...
function loadXML(_templtext)
{
	...
	<textarea NOWRAP name="header" type="text" cols="45" rows="9"><%=formarr[enumfld["header"]]?Server.HTMLEncode(formarr[enumfld["header"]]):""%></textarea><img src=../images/ii_xmlvalid.gif onclick=alert(loadXML(document.main.header.value)) hspace=4><%if(detaildb){%><input type=image src=../images/ii_xmlupdate.gif name="act" value="update"><%}%>

	</td>
	<td align="left" style="background-color:white" rowspan="3">«&nbsp;<%=_T["admin_header"]%></td>
</tr>

<tr><td align="right" style="background-color:white"><%=_T["admin_description"]%>&nbsp;»</td><td align="right" style="background-color:#e0e0e0" width=100><input name="desc" type="text" value="<%=formarr[enumfld["desc"]]%>" style="width:100px"></td></tr>
...
<tr><td></td><td></td><td align="right" style="background-color:#e0e0e0"><input name="url" type="text" value="<%=formarr[enumfld["url"]]?formarr[enumfld["url"]]:""%>" size="<%=2*ctxtwidth%>"></td><td align="right" style="background-color:white">«&nbsp;script</td></tr>
<tr><td></td><td></td><td align="right" style="background-color:#e0e0e0"><input name="publisher" type="text" value="<%=formarr[enumfld["publisher"]]?formarr[enumfld["publisher"]]:""%>" size="<%=2*ctxtwidth%>"></td><td align="right" style="background-color:white">«&nbsp;master &amp; detaildb</td></tr>
<!--tr><td></td><td></td><td align="right" style="background-color:#e0e0e0"><input name="category" type="text" value="<%=formarr[enumfld["category"]]?formarr[enumfld["category"]]:""%>" size="<%=2*ctxtwidth%>"></td><td align="right" style="background-color:white">«&nbsp;template id</td></tr-->
<tr><td></td><td></td><td align="right" style="background-color:#e0e0e0"><input name="refcat" type="text" value="<%=formarr[enumfld["refcat"]]?formarr[enumfld["refcat"]]:""%>" size="<%=2*ctxtwidth%>"></td><td align="right" style="background-color:white">«&nbsp;reference id</td></tr>
</table>

<center><a href="<%=zerofill(ds_type,2)%>_ops_dlg.asp?id=<%=Request.QueryString("id").Item%>">[operations]</a></center>
