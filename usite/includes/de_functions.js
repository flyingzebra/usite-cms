	...
	function editMe() {
		if (editModeView == false)
		{
			...
			document.getElementById("editTab").src = deveditPath1 + "/images/status_edit_up.gif"
			document.getElementById("sourceTab").src = deveditPath1 + "/images/status_source.gif"
			document.getElementById("previewTab").src = deveditPath1 + "/images/status_preview.gif"
			initFoo()
			foo.focus()
		}
	}
	...
	function sourceMe() {
		if (sourceModeView == false)
		{
			...
			document.getElementById("editTab").src = deveditPath1 + "/images/status_edit.gif"
			document.getElementById("sourceTab").src = deveditPath1 + "/images/status_source_up.gif"
			document.getElementById("previewTab").src = deveditPath1 + "/images/status_preview.gif"
	...
	function previewMe() {
		if (previewModeView == false)
		{
			...
			document.getElementById("editTab").src = deveditPath1 + "/images/status_edit.gif"
			document.getElementById("sourceTab").src = deveditPath1 + "/images/status_source.gif"
			document.getElementById("previewTab").src = deveditPath1 + "/images/status_preview_up.gif"
		}
	}
	...
	function toggleTick(tick, state) {
		...
		if(tick.id.indexOf("zoom" + zoomSize + "_") > -1)
		{
			if(state == 1)
			{
				...
				tick.src = 'de/images/button_tick_inverted.gif'
			}
			else
			{
				// We are over the selected zoom
				tick.src = 'de/images/button_tick.gif'
			}
		}
	}
