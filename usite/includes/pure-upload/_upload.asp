...
Class ASPForm
	...
	public Property Get Files
		Response.Write("ASPForm: Get Files<br>")
		Read
	...
	Public Sub Read()
		...
		Do While BytesRead < TotalBytes
			...
			Response.Write("PartSize="&PartSize&"<br>vartype(PartSize)="&vartype(PartSize)&"<br>")
	...
	Private Sub Class_Initialize()
		...
		Response.Write("ASPForm Constructor: Class_Initialize()<br>")
		Response.Write("TotalBytes = " & TotalBytes & "<br>")
	End Sub
...
Class cFormFields
	...
	Public Sub Save(Path)
		...
		Response.Write("ASPForm Save(" & Path & ")<br>")
		Dim dPart
		dPart = 0
