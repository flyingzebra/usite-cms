...
function ReadFile(filename)
{
	...
	if(pid)
	{
		...
		var pid = pid ? Number(pid) : -1
				...
				//Response.Write(numberbase)
				//Response.Write(Server.HTMLEncode(ReadFile(xmlfile).replace(new RegExp(numberbase+".dtd","i"),"../editionsalliages/xml/"+numberbase+".dtd")+"</ROOT>").replace(/\r\n/g,"<br>"))
				Response.Write(ReadFile(xmlfile).replace(new RegExp(numberbase+".dtd","i"),"../"+_ws+"/xml/"+numberbase+".dtd")+"</ROOT>")
	}	
